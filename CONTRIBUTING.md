...
`arena/01a018f0-tacztweaks-unofficial` working branch in Arena sessions; normal GitHub work should
...
source or binary inspected, test scenario, and known boundaries. If a mod has no Fabric 26.1.2 target,
