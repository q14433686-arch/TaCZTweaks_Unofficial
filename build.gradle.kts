...
dependencies {
    ...
    // YACL (YetAnotherConfigLib) — 3.9.x API stub; the 26.3 runtime build is gated in
    // fabric.mod.json (=3.9.7+26.3-fabric). The stub jar is the last checksummed copy
    // (3.9.6+26.2, same 3.9.x API surface) until a maintainer with Modrinth access
    // refreshes libs/ via scripts/download_dependencies.py.
