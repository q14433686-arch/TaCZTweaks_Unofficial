...
本文件位于 **`26.3`** 线（Fabric 26.3）。每条线有独立源码、依赖、构建脚本和产物版本号；不要把某
一条线的 jar、配置或 issue 结论套到另一条线上。

## 当前分支

| Git 分支 | 加载器 | Minecraft | 目标 TaCZ 移植 | 典型产物版本前缀 | 本文件所在线 |
|---|---|---|---|---|---|
| [`26.3`](https://github.com/q14433686-arch/TaCZTweaks_Unofficial/tree/26.3) | Fabric | 26.3 | [TaCZ_Refabricated_Unofficial](https://github.com/q14433686-arch/TaCZ_Refabricated_Unofficial) | `2.14.2+fabric.26.3.` | **是（当前检出）** |
| [`26.2(main)`](https://github.com/q14433686-arch/TaCZTweaks_Unofficial/tree/26.2(main)) | Fabric | 26.2 | TaCZ_Refabricated_Unofficial | `2.14.2+fabric.26.2.` | 否（仓库默认分支） |
