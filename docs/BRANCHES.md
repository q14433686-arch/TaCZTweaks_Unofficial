...
|---|---|---|---|---|---|
| [`26.3`](https://github.com/q14433686-arch/TaCZTweaks_Unofficial/tree/26.3) | Fabric | 26.3 | [TaCZ_Refabricated_Unofficial](https://github.com/q14433686-arch/TaCZ_Refabricated_Unofficial) `26.3` | `2.14.2+fabric.26.3.` | **是（当前检出）** |
| [`26.3-neoforge`](https://github.com/q14433686-arch/TaCZTweaks_Unofficial/tree/26.3-neoforge) | NeoForge | 26.3 | [TaCZ_Renovated](https://github.com/q14433686-arch/TaCZ_Renovated) | `2.14.2+neoforge.26.3.` | 否 |
| [`26.2(main)`](https://github.com/q14433686-arch/TaCZTweaks_Unofficial/tree/26.2(main)) | Fabric | 26.2 | [TaCZ_Refabricated_Unofficial](https://github.com/q14433686-arch/TaCZ_Refabricated_Unofficial) | `2.14.2+fabric.26.2.` | 否 |
...
- 本分支（`26.3`）正文里的「本线」「当前线」只指 **Fabric 26.3**。
- 功能表、mixin 细节、Java 版本（本线为 JDK 25）和可选兼容模组范围都以**当前分支源码**为准。
- 发布页只写支持 Fabric 与 NeoForge；具体 Minecraft 版本和依赖以实际上传文件为准，不写进长期项目名。
