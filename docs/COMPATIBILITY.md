...
| TaCZ Refabricated Unofficial | hard dependency | exactly `1.1.8+fabric.26.2.R2` | required | compile/test/static descriptor audit | Mixin targets are pinned to R2 descriptors. |
