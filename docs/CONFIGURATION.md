...
| `crawl.visualTweak` | `true` | client/local | Smooths 26.1.2 avatar crawl transition rendering. |
...
compatibility switch is kept for unavailable Fabric 26.1.2 targets.
...
person rendering fix; the other targets do not currently have supported Fabric 26.1.2 mods to
inject into.
