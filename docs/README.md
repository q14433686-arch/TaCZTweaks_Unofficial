...
本页与同目录其它文档描述的是 **`26.3` / Fabric 26.3** 线。NeoForge 与 26.2、26.1.2、1.21.11 线的依赖、Java 版本和构建步骤以对应 Git 分支上的文档为准，先看 [分支对照](BRANCHES.md)。

## 玩家与服务器管理员

- [维护分支与发行线](BRANCHES.md)
- [安装、依赖与构建](../BUILD.md)
...
- [**26.3 移植状态与待办**](PORT_26_3_STATUS.md) ← 本线在建，先读这个
- [当前审计结论](../AUDIT.md)
