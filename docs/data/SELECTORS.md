...
| `burst_index` | `index: int bounds` | Matches burst cycle index attached by the port's shooting hook. |
| `pellet_index` | `index: int bounds` | Matches pellet index attached by the port's projectile hook. |
