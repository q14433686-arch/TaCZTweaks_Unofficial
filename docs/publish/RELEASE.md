...
| Minecraft | 分支 | 版本 | 状态 |
|---|---|---|---|
| 26.2 | `26.2-neoforge` | 未开始 | 该分支当前仍指向 Fabric 内容，移植工单见 `docs/records/`（26.1.2 线的计划与记录可直接复用） |
| 26.1.2 | `26.1.2-neoforge` | `2.14.2+neoforge.26.1.2.Beta-1` | 源码移植完成，尚未发布 |
...
| NeoForge 26.2 | 未开始 | 未开始 | 未开始 | 未开始 | 未开始 |

未完成项在对外文案里一律写「未实测」，不得写成「已支持 / 已修复」。

NeoForge 26.1.2 线的已知未完成事项：
