...
/**
 * Broadcast inspect/bolt/draw animation sounds the same way {@code SoundPlayManagerMixin}
 * broadcasts the named play* methods. 26.2 still calls {@code playAnimationSound}.
 */
...
public abstract class ObjectAnimationSoundChannelMixin {
    ...
    private GunSoundInstance tacztweaks$playSound$broadcast(Entity entity, Identifier name, float volume, float pitch, int distance, Operation<GunSoundInstance> original) {
