...
class CodecSmokeTest {
    ...
    @Test
    fun `example interaction fixture decodes`() {
        assertFixtureDecodes("/fixtures/bullet_interaction_glass.json", BulletInteraction.CODEC)
    }

    @Test
    fun `example sound fixture decodes`() {
        assertFixtureDecodes("/fixtures/bullet_sound_whizz.json", BulletSounds.CODEC)
    }

    @Test
    fun `example particle fixture decodes`() {
        assertFixtureDecodes("/fixtures/bullet_particle_hit.json", BulletParticles.CODEC)
    }
